...
client::client(QObject *parent) : //konstruktor, pusty, po co cokolwiek tu
        QObject(parent)
{                          // to jest coś z dziedziczenie
...
//          socket->waitForReadyRead(3000);                  //czeka na sygmnał o nowych danych do przeczytania
